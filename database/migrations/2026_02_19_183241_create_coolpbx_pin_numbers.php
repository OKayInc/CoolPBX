...
return new class extends Migration
{
    ...
    {
        $tableName = PinNumber::getTableName();
    ...
    private function dql(Blueprint $table): void
    {
        ...
        $table->uuid('pin_number_uuid')->nullable(false)->primary()->first();
        $table->uuid('domain_uuid')->nullable();
        $table->string('pin_number', length: 255)->nullable(false);
        $table->string('accountcode', length: 3)->nullable();
