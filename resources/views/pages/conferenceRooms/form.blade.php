...
<div class="container-fluid">
    <div class="card card-primary mt-3">
        ...
        <form action="{{ isset($conferenceRoom) ? route('conference_rooms.update', $conferenceRoom->conference_room_uuid) : route('conference_rooms.store') }}"
              method="POST">
            @csrf
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="conference_center_uuid">
                                @foreach($conferenceCenters as $conferenceCenter)
                                <option value="{{ $conferenceCenter->conference_center_uuid }}" @selected(old('conference_center_uuid', $conferenceRoom->conference_center_uuid ?? null) == $conferenceCenter->conference_center_uuid)>{{ $conferenceCenter->conference_center_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('conference_room_name', $conferenceRoom->conference_room_name ?? '') }}"
                                required
                            >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="record" name="record" value="true" {{ old('record', $conferenceRoom->record ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="wait_mod" name="wait_mod" value="true" {{ old('wait_mod', $conferenceRoom->wait_mod ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="moderator_endconf" name="moderator_endconf" value="true" {{ old('moderator_endconf', $conferenceRoom->moderator_endconf ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="announce_name" name="announce_name" value="true" {{ old('announce_name', $conferenceRoom->announce_name ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="announce_count" name="announce_count" value="true" {{ old('announce_count', $conferenceRoom->announce_count ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="announce_recording" name="announce_recording" value="true" {{ old('announce_recording', $conferenceRoom->announce_recording ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="mute" name="mute" value="true" {{ old('mute', $conferenceRoom->mute ?? true) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('email_address', $conferenceRoom->email_address ?? '') }}"
                            >
                            @error('email_address')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('account_code', $conferenceRoom->account_code ?? '') }}"
                            >
                            @error('account_code')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="enabled" name="enabled" value="true" {{ old('enabled', $conferenceRoom->enabled ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="sounds" name="sounds" value="true" {{ old('sounds', $conferenceRoom->sounds ?? true) ? 'checked' : '' }}>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            >{{ old('description', $conferenceRoom->description ?? '') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
