<div>
    {{-- Bootstrap Modal for Add/Edit Greeting --}}
    @if($showModal)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">
                                                <i class="fas fa-info-circle"></i> Enter a unique, descriptive name for this greeting
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   wire:model="greeting_description"
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">
                                                <i class="fas fa-info-circle"></i> Optional description to help identify this greeting
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="alert alert-info mb-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <strong><i class="fas fa-check-circle mr-1"></i>Current Audio File:</strong>
                                                <br>
                                        ...
                                        <small class="text-muted">
                                            <i class="fas fa-arrow-circle-up"></i> Upload a new file below to replace the current one
                                        </small>
                                    </div>
                                @endif
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="border rounded p-4 text-center bg-light position-relative" 
                                                ...
                                                {{-- Loading State --}}
                                                <div wire:loading wire:target="greeting_file" class="text-primary">
