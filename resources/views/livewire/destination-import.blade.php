            ...
            <div class="card-body">
                ...
                @if ($step == 1)
                    <div class="alert alert-info">
                        ...
                        Import destination data from CSV files. You can paste CSV data directly or upload a file.
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <ul class="list-unstyled small">
													...
													<li>• user_uuid</li>
													<li>• group_uuid</li>
													<li>• destination_type</li>
													<li>• destination_number</li>
													<li>• destination_trunk_prefix</li>
													<li>• destination_area_code</li>
													<li>• destination_prefix</li>
													<li>• destination_condition_field</li>
													<li>• destination_number_regex</li>
													<li>• destination_caller_id_name</li>
													<li>• destination_caller_id_number</li>
													<li>• destination_cid_name_prefix</li>
													<li>• destination_context</li>
													<li>• destination_record</li>
													<li>• destination_hold_music</li>
													<li>• destination_distinctive_ring</li>
													<li>• destination_accountcode</li>
													<li>• destination_type_voice</li>
													<li>• destination_type_fax</li>
													<li>• destination_type_emergency</li>
													<li>• destination_type_text</li>
													<li>• destination_conditions</li>
													<li>• destination_actions</li>
													<li>• destination_app</li>
													<li>• destination_data</li>
													<li>• destination_alternate_app</li>
													<li>• destination_alternate_data</li>
													<li>• destination_order</li>
													<li>• destination_enabled</li>
													<li>• destination_description</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select wire:model="delimiter" class="form-select @error('delimiter') is-invalid @enderror" id="delimiter">
                ...
                @elseif($step == 2)
                    <form wire:submit.prevent="continue">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i>
                            Map each column from your CSV file to the corresponding destination fields. Fields are organized by table.
                        </div>
                        ...
                        @if (!empty($headers))
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="submit" class="btn btn-success btn-lg">
                                    <i class="fas fa-upload"></i> Import Destinations
                                </button>
                            </div>
                        @endif
                    </form>
                ...
                @elseif($step == 3)
                    <div class="alert alert-success">
                        ...
                        <p class="mb-0">
                            <strong>{{ $importResults['success'] }}</strong> destinations were successfully imported or updated.
                        </p>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center">
									<i class="fa-solid fa-arrow-right-arrow-left fa-3x text-primary mb-3"></i>
                                    <h5>View Imported Destinations</h5>
                                    <p class="text-muted">Check the destinations that were imported</p>
                                    <a href="{{ route('destinations.index') }}" class="btn btn-primary">
                                        <i class="fas fa-list"></i> View All Destinations
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h5>Import More Destinations</h5>
