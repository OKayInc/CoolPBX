...
return new class extends Migration
{
    ...
    {
        $tableName = MenuItemGroup::getTableName();
    ...
    private function dql(Blueprint $table): void
    {
        ...
        $table->uuid('menu_item_group_uuid')->nullable(false)->primary()->first();
        ...
        $table->comment('CoolPBX menu item group relationship information');
