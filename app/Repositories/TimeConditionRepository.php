...
class TimeConditionRepository
{
    ...
    {
        return Dialplan::where('app_uuid', config('coolpbx.time_conditions.app_uuid'))
    ...
    public function findByUuid(string $uuid, bool $withDetails = false): ?Dialplan
    {
        $query = Dialplan::where('dialplan_uuid', $uuid)
            ->where('app_uuid', config('coolpbx.time_conditions.app_uuid'));
    ...
    public function create(
        ...
        try {
            ...
            $dialplanData = [
                ...
                'app_uuid' => config('coolpbx.time_conditions.app_uuid'),
