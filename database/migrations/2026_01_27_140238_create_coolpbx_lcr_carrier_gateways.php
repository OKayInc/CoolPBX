...
return new class extends Migration
{
    ...
    {
        $tableName = CarrierGateway::getTableName();
    ...
    private function dql(Blueprint $table): void
    {
        ...
        $table->uuid('carrier_gateway_uuid')->nullable(false)->primary()->first();
        $table->uuid('carrier_uuid')->nullable(false);
        $table->uuid('gateway_uuid')->nullable(false);
        $table->string('prefix', length: 255)->nullable();
        $table->string('suffix', length: 255)->nullable();
        $table->string('codec', length: 255)->nullable();
        ...
        $table->comment('CoolPBX lcr carrier relationship information');
    }
};
