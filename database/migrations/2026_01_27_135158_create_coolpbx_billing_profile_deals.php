...
return new class extends Migration
{
    ...
    private function dql(Blueprint $table): void
    {
        ...
        $table->uuid('billing_profile_deal_uuid')->nullable(false)->primary()->first();
        $table->uuid('billing_uuid')->nullable(false);
        $table->uuid('domain_uuid')->nullable(false);
        $table->uuid('billing_deal_uuid')->nullable(false)->comment('user_uuid');
        ...
        $table->comment('CoolPBX billing profile deals information');
