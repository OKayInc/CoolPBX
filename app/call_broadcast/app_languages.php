...
$text['description-timeout']['en-us'] = "Specify the absolute timeout in seconds. Keep it blank to use the system default.";
$text['description-timeout']['en-gb'] = "Specify the absolute timeout in seconds. Keep it blank to use the system default.";
...
$text['description-timeout']['es-cl'] = "Especifique el tiempo de espera absoluto en segundos. En blanco para utilizar los valores por defecto del sistema.";
$text['description-timeout']['es-mx'] = "Especifique el tiempo de espera absoluto en segundos. En blanco para utilizar los valores por defecto del sistema.";
$text['description-timeout']['fr-ca'] = "Spécifiez le délai d'expiration absolu en secondes. Gardez-lui vide pour utilizer les valeurs défault du systéme.";
$text['description-timeout']['fr-fr'] = "Spécifiez le délai d'expiration absolu en secondes. Gardez-lui vide pour utilizer les valeurs défault du systéme.";
