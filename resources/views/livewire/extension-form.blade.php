                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('extension') is-invalid @enderror"
                                            id="extension" wire:model="extension" placeholder="Enter extension number"
                                            required>
                                        @error('extension')
                            ...
                            @can('number_alias')
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('number_alias') is-invalid @enderror"
                            ...
                            @can('extension_accountcode')
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('accountcode') is-invalid @enderror" id="accountcode"
                                            wire:model="accountcode" placeholder="Enter account code">
                                        @error('accountcode')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @can('effective_caller_id_number')
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="effective_caller_id_number" class="form-label">Effective
                                                    Caller ID
                                                    Number</label>
                                                <input type="text"
                                                    class="form-control @error('effective_caller_id_number') is-invalid @enderror"
                                                    id="effective_caller_id_number"
                                                    wire:model="effective_caller_id_number"
                                ...
                                <div class="row">
                                    ...
                                    @can('outbound_caller_id_number')
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="outbound_caller_id_number" class="form-label">Outbound Caller
                                                    ID
                                                    Number</label>
                                                <input type="text"
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                @if (auth()->user()->hasPermission('emergency_caller_id_select'))
                                                    @if ($emergency_destination && $emergency_destination->isNotEmpty())
                                                        <select
                                                            class="form-control @error('emergency_caller_id_name') is-invalid @enderror"
                                                            id="emergency_caller_id_name"
                                                            wire:model="emergency_caller_id_name">
                                                            <option value=""></option>
                                                            @foreach ($emergency_destination as $dest)
                                                                @php
                                                                    $name =
                                                    ...
                                                    @else
                                                        <button type="button" class="btn btn-primary btn-sm"
                                                            onclick="window.location='{{ route('destinations.index') }}'">
                                                            <i class="fa fa-plus"></i> {{ __('Destination') }}
                                                        </button>
                                                    @endif
                                                @else
                                                    <input type="text"
                                                ...
                                                @error('emergency_caller_id_name')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                                <small class="form-text text-muted">
                                                    {{ __('Emergency Caller ID Name description') }}
                                                </small>
                                            </div>
                                        </div>
                                    @endcan
                                    ...
                                    @can('emergency_caller_id_number')
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="emergency_caller_id_number" class="form-label">
                                                ...
                                                @if (auth()->user()->hasPermission('emergency_caller_id_select'))
                                                    @if ($emergency_destination && $emergency_destination->isNotEmpty())
                                                        <select
                                                            ...
                                                            wire:model="emergency_caller_id_number">
                                                            @if (auth()->user()->hasPermission('emergency_caller_id_select_empty'))
                                                                <option value=""></option>
                                                            @endif
                                                            @foreach ($emergency_destination as $dest)
                                                                @php
                                                                    $number =
                                                                        $dest->destination_caller_id_number ?:
                                                ...
                                                @enderror
                                                <small class="form-text text-muted">
                                                    {{ __('Emergency Caller ID Number description') }}
                                                </small>
                                            </div>
                                        </div>
                                    @endcan
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="voicemail_enabled" class="form-label">Voicemail
                                                    Enabled</label>
                                                <select
                                                    class="form-select @error('voicemail_enabled') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="voicemail_password" class="form-label">Voicemail
                                                    Password</label>
                                                <input type="password"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="voicemail_mail_to" class="form-label">Voicemail Mail
                                                    To</label>
                                                <input type="text"
                                        ...
                                        @can('voicemail_transcription_enabled')
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="voicemail_transcription_enabled"
                                                        class="form-label">Transcription
                                                        Enabled</label>
                                                    <select
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="directory_visible" class="form-label">Directory
                                                Visible</label>
                                            <select
                                                class="form-select @error('directory_visible') is-invalid @enderror"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="max_registrations" class="form-label">Max
                                                Registrations</label>
                                            <input type="number"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="limit_destination" class="form-label">Limit
                                                Destination</label>
                                            <input type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="call_group" wire:model="call_group"
                                                    placeholder="Enter call group">
                                                @error('call_group')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="call_screen_enabled" class="form-label">Call Screen
                                                    Enabled</label>
                                                <select
                                                    class="form-select @error('call_screen_enabled') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="hold_music" wire:model="hold_music"
                                                    placeholder="Enter hold music">
                                                @error('hold_music')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3" wire:ignore>
                                            ...
                                            <input type="text"
                                                ...
                                                id="toll_allow" wire:model="toll_allow"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="sipAdvancedHeading">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#sipAdvancedCollapse"
                                            aria-expanded="false" aria-controls="sipAdvancedCollapse">
                                    ...
                                    <div id="sipAdvancedCollapse" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="sip_force_contact" class="form-select"
                                                            ...
                                                            <option value="NDLB-connectile-dysfunction"> NDLB connectile
                                                                dysfunction</option>
                                                            <option value="NDLB-connectile-dysfunction-2.0"> NDLB
                                                                connectile
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="sip_bypass_media" class="form-select"
                                                            ...
                                                            <option value="bypass-media-after-bridge">Bypass Media After
                                                                Bridge
                                                            </option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="absolute_codec_string" class="form-label">Absolute
                                                            Codec
                                                            String</label>
                                                        <input type="text"
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        ...
                                        {{ isset($extensions) ? __('Update') : __('Create') }}
                                    </button>
                                </div>
                            </div>
                        </div>
