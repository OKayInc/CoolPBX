...
return new class extends Migration
{
    ...
    {
        $tableName = DeviceVendorFunctionGroup::getTableName();
    ...
    private function dql(Blueprint $table): void
    {
        ...
        $table->uuid('device_vendor_function_group_uuid')->nullable(false)->primary()->first();
        ...
        $table->comment('CoolPBX device vendor function details information');
    }
};
